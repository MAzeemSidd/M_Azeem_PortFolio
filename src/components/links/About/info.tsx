...
export const InfoDiv: FC<InfoDivType> = ({ heading, subHeading, duration, description, svg, link }) => (
  <div className='group relative z-0 h-auto bg-gradient-to-r from-light-blue-300 to-blue-50 rounded-xl p-[1px] hover:bg-[#020618] hover:from-transparent hover:to-transparent shadow-none transition-all duration-500 ease-out hover:shadow-[rgb(197,255,255)_0px_0px_15px_2px]'>
    <div className='relative z-30 bg-[#020618] group-hover:bg-[#171717] rounded-xl px-5 md:px-10 lg:px-20 py-8 sm:py-12 flex flex-col gap-5'>
      <div className='absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 h-full min-w-full max-w-[500px] bg-light-blue-300/85 blur-2xl opacity-20 rounded-full' />
      ...
      {
        link &&
        <div className='relative z-40 flex justify-end px-5 text-base font-light underline text-light-blue-100 hover:text-light-blue-300 cursor-pointer'>
