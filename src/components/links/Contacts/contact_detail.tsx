...
import { CopiedSVG, CopySVG, PhoneSVG, GitHubSVG, LinkedInSVG, MailSVG, VisitWebsiteSVG, SendMailSVG, CallingSVG } from "./svgs";
...
export function ContactBox ({ buttonType, title, text }: ContactBoxType) {
  ...
  let MainSVG, linkBtnTitle, LinkBtnSVG, href;
